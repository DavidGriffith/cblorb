...
translated project, together with any pictures, sounds, data resources, or
cover art, into a single file called a ``blorb'' which can be given to
players on other machines to play; and to produce associated websites,
solution files and so on as demanded by ``Release...'' instruction(s) in
the source text.  }
